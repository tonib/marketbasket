...
class RatingPrediction(Prediction):
    ...
    @tf.function
    def repeat_batch_inputs(self, input_batch, n_items_result: int):
    ...
    @tf.function
    def calculate_ratings(self, input_batch, top_item_indices, n_items_result: int):
        ...
        input_batch.append(items_to_rate)
